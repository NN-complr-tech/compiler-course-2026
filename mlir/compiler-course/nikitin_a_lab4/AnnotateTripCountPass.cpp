...
namespace {
class AnnotateTripCountPass : public PassWrapper<AnnotateTripCountPass, OperationPass<ModuleOp>> {
public:
  StringRef getArgument() const final { return "nikitin_a_lab4_MLIR"; }
  StringRef getDescription() const final { 
    return "Annotate affine.for loops with trip_count attribute representing the number of iterations"; 
  }
